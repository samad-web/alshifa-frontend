...
interface GenerateReportButtonProps {
     ...
     *  replaces the default outline-primary styling — used in places that
     *  want the action shown as a filled primary CTA (e.g. the
     *  Consultation Room page header). The component's internal modal
     *  flow is unaffected. */
    ...
    return (
        <TooltipProvider delayDuration={250}>
            <Button
                ...
                size="sm"
                onClick={handleOpen}
                className={triggerClassName ?? "border-primary text-primary hover:bg-primary/10 hover:text-primary"}
            >
